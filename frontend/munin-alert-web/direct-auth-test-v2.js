// Direct authentication test script with shorter username
...
async function registerUser() {
    ...
    // Make sure username is no longer than 20 characters
    const username = `test${timestamp % 10000}`; // This will be shorter than 20 chars
